...
import { postComment, fetchDishes, fetchComments, fetchPromos, fetchLeaders, postFeedback,loginUser,signupUser, logoutUser, fetchFavorites, postFavorite, deleteFavorite } from '../redux/ActionCreators';
...
const mapDispatchToProps = (dispatch) =>({
  ...
  signupUser: (credsdetails) => dispatch(signupUser(credsdetails)),
